...
-- Moved/disabled here because this table may not exist yet: ALTER TABLE Services
-- ADD ImageUrl NVARCHAR(255);
GO

-- Moved/disabled here because this table may not exist yet: UPDATE Services
...
-- Moved/disabled here because this table may not exist yet: ALTER TABLE Users
...
-- =========================
-- EXTRA COLUMNS FOR FRONTEND UI
-- Run after tables Users and Services are created.
-- =========================
IF COL_LENGTH('Services', 'ImageUrl') IS NULL
    ALTER TABLE Services ADD ImageUrl NVARCHAR(255);
GO
...
IF COL_LENGTH('Users', 'VerifyCode') IS NULL
    ALTER TABLE Users ADD VerifyCode NVARCHAR(10);
GO
